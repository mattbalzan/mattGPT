...
$WorkingFilePath = "Path"  # Replace "Path" with your desired working directory
...
$DaysBack = 32  # Adjust this value as needed
$ExcludeRecentHours = 0  # Exclude devices enrolled in the last X hours

# Define Azure Application credentials
$ApplicationClientId = 'YOUR_CLIENT_ID'           # Replace with your Application (Client) ID
$TenantId = 'YOUR_TENANT_ID'                     # Replace with your Tenant ID
$CertificateThumbprint = 'YOUR_CERTIFICATE_THUMBPRINT'  # Replace with your Certificate Thumbprint
